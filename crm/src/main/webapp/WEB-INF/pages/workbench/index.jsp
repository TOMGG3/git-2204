...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="page/workbench/main/index" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
            ...
            <li class="liClass"><a href="page//workbench/activity/index" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 市场活动</a></li>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        window.open("page/workbench/main/index","workareaFrame");
    });
    function logout(){
        $.ajax('auth/logout',{
            type: 'get',
